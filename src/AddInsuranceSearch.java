...
public class AddInsuranceSearch extends JFrame{
	...
	JComboBox cb1;
        ...
        Connection d;
        ResultSet rs;
	public AddInsuranceSearch(String s1)
	{
    ...
    private class ButtonHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
                {
                    if(e.getSource()==b1)
                    {   AddInsurance pw = new AddInsurance(String.valueOf(cb1.getSelectedItem()),name); // create ButtonFrame
